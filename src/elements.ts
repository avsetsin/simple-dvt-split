export const clusterTypeElement = document.getElementById('cluster-type') as HTMLSelectElement;
export const splitAddressElement = document.getElementById('split-address') as HTMLInputElement;
